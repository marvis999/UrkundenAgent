...
export function FieldRow({ view, field, expanded, activePartId }: FieldRowProps) {
  ...
  return (
    ...
    >
      <FieldDetail view={view} field={field} activePartId={activePartId} />
    </Disclosure>
  );
}
